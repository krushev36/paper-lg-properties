...
awk 'NR>1 && NF>1 {print }' 10909/10909-0.0.1-run-v16-mwtype-props-z0.005.dat > tot/0.0.1-run-v16-mwtype-props-z0.005.dat
awk 'NR>1 && NF>1 {print }' 10909/10909-0.0.1-run-v16-luminosity-z0.1.dat > tot/0.0.1-run-v16-luminosity-z0.1.dat
awk 'NR>1 && NF>1 {print }' 10909/10909-0.0.1-run-v16-tully-fisher2-z0.1.dat > tot/0.0.1-run-v16-tully-fisher2-z0.1.dat
