...
#define HALOmASSrEFF   1.275E12  
#define DISKsTELLARmASSrEF 3.9E10  
#define DISKgASmASSrEF  0.7E10   
#define BULGEsTELLARmASSrEF 0.85E10
#define CIRCULARvELOCITYrEF  238
#define DISKsCALElEGTHrEF   3.04
...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  fprintf(file_output, "#1.ID  #2.nodeMass   #3.spheroidStellarMass   #4.spheroidGasMass  #5.diskStellarMass  #6.diskGasMass"
	  "#7.diskCircularVelocity  #8.spheroidCircularVelocity   #9.diskScaleLength   #10.delta   #11.eta-count\n"
	  );
